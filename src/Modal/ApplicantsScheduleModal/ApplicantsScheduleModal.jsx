...
import ApplicantsScheduleProcess from './ApplicantsScheduleConfirmation/ApplicantsScheduleProcess';

const ApplicantsScheduleModal = ({ applicant, setIsOpen, isOpen, gotAccess, refetch }) => {
  function closeModal() {
    setIsOpen(false);
  }
      ...
      <Dialog as="div" className="relative z-50" onClose={closeModal}>
        ...
        <div className="fixed inset-0">
          <div className="flex h-full items-center justify-center p-2 text-center">
            ...
            >
              <Dialog.Panel className="w-full lg:w-[90%] lg:h-[85vh]  transform rounded-2xl bg-[#f0f9ff]  text-left align-middle shadow-xl transition-all relative">
...
export default ApplicantsScheduleModal;
