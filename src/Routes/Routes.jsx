...
import RemoStartupProfile from '../Pages/RemoForceDashBoard/RemoForceMyJob/RemoStartupProfile';
...
import MyToolDei from '../Pages/StartupDashboard/MyTools/Dei/MyToolDei';
import ExcelUploader2 from '../Pages/StartupDashboard/MyTools/Interview/ExcelUploader2';
import MyTools from '../Pages/StartupDashboard/MyTools/MyTools';
import MyToolResume from '../Pages/StartupDashboard/MyTools/Resume/MyToolResume';
import Applications from '../Pages/StartupDashboard/PostJob/Applicants/Applications';
...
import StartupProfileRoute from './StartupProfileRoute';
    ...
    <Route>
      <Route path="/" element={<Root />} errorElement={<ErrorPage />}>
        ...
        >
          ...
          <Route path="/dashboard/my-tools" element={<MyTools />} />
          <Route path="/dashboard/my-tools/new-tool/interview" element={<ExcelUploader2 />} />
          <Route path="/dashboard/my-tools/new-tool/dei" element={<MyToolDei />} />
          <Route path="/dashboard/my-tools/new-tool/resume" element={<MyToolResume />} />
          ...
          <Route path="/dashboard/public/:id/view-applicants" element={<Applications />} />
          ...
          <Route path="/dashboard/private/:id/view-applicants" element={<Applications />} />
          ...
          <Route path="/dashboard/internship/:id/view-applicants" element={<Applications />} />
          ...
          <Route path="/dashboard/gigs/:id/view-applicants" element={<Applications />} />
          {/* shadowing post job */}
          ...
          <Route path="/dashboard/shadowing/:id/view-applicants" element={<Applications />} />
          {/* Contracts */}
          ...
          <Route path="/dashboard/contracts/:id/view-applicants" element={<Applications />} />
          {/* view application */}
          {/* Talents Request history  */}
          <Route path="/dashboard/talent-request-history" element={<TalentRequestHistory />} />
        </Route>
        {/* remoforce profile view from startup */}
        <Route
        ...
        />
        {/* startups profile view from remoforce */}
        <Route
          path="/startup/profile/:email"
          element={
            <StartupProfileRoute>
              <RemoStartupProfile />
            </StartupProfileRoute>
        ...
        >
          ...
          <Route path="/remoforce-dashboard/view-jobs/:id" element={<ApplyJob />} />
        ...
        <Route path="/blog" element={<Blogs />}>
          ...
          <Route
            ...
            loader={async ({ params }) =>
              fetch(`${import.meta.env.VITE_APP_URL}/category-blogs/${params.id}`)
            }
          />
        </Route>
