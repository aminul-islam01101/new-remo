...
const RemoForceProfile = () => {
  ...
  const { data: remoProfile, refetch } = useQuery(['remoProfile'], () =>
    axios
      .get(
        `${import.meta.env.VITE_APP_URL_STARTUP}/api/remoforce/remoforce-profile/${
  ...
  return (
    <div className="w-full">
        ...
        <div className="lg:flex absolute w-full  gap-5 justify-between -top-12 2xl:-top-10 left-5 items-center ">
          ...
          <div className="font-bold text-[14px]   md:mt-5 lg:mt-12 xl:mt-12   w-full ">
            <div className="lg:flex justify-between w-full  ">
              <div>
                <div className="lg:flex md:flex justify-between  w-full gap-5 items-center">
                  ...
                  <div className="lg:w-8/12 my-2 lg:my-0 gap-5 flex lg:justify-between md:justify-between items-center">
                    <button type="button">
                      <Link
                        title="Edit Profile"
                    ...
                    <button
                      type="button"
                      className="pr-4 outline-none text-[#999999] items-center cursor-pointer max-md:mt-2   lg:pr-10 flex text-md md:text-lg space-x-2"
                    >
                      <span>
      ...
      {/* about me */}
      <div className="mt-[300px] lg:mt-[120px] flex flex-col lg:grid grid-cols-7 pl-0 lg:pl-6">
