...
const ApplyJob = () => {
  ...
  const { data: job, refetch } = useQuery(['job'], () =>
    axios
      .get(
        `${import.meta.env.VITE_APP_URL_STARTUP}/api/job/apply-status?id=${id}&email=${
  ...
  const postedDate = job?.createdAt || '2023-05-15T09:09:24.851+00:00';

  const applyJobHandler = () => {
    const url = `${import.meta.env.VITE_APP_URL_STARTUP}/api/job/user-jobs/${id}`;
    const jobType = categoryName.split(' ')[0].toLowerCase();
    ...
    axios
      ...
      .catch((error) => {
        toast.error('Error making PUT request:', error);
      });
  };
      ...
      <div>
        ...
        <div className="pb-1 border-b border-[#9999996e] mb-3">
          <button
            onClick={() => navigate(-1)}
            type="button"
            className="text-3xl outline-none font-semibold flex gap-2 items-center"
          >
            <span>
        ...
        <div className="relative right-[-6px]  md:right-[-36px] top-[123px] md:top-[117px] lg:top-[110px]">
          <div className="flex gap-[10px] items-center">
            <div className="bg-[#F0F9FF] w-[85px] md:w-[131px] bg-red rounded-full shadow-2xl shadow-[#DDB6FF] p-4 md:p-10">
              ...
              {startupsProfilePhoto ? (
                ...
                // <p className=" text-3xl h-12 grid place-items-center font-semibold text-purple-500 rounded-full ">
          ...
          <h1 className="mt-5 -ml-4 lg:text-2xl text-xl font-bold text-stone-500">
            {` Posted ${getPostedDays(postedDate)} days ago`}
          </h1>
        </div>
        <div className="mt-[130px] lg:mt-[110px] lg:ml-5">
          ...
          <div className="mt-5 lg:grid lg:grid-cols-6 ">
            ...
            <div className=" lg:col-span-2 lg:border-l-2 lg:pl-4  md:border-t-2  lg:border-t-0">
              ...
              <div>
                ...
                <div className="">
                  <div className="bg-[#F0F9FF] mt-3 w-[200px] flex items-center gap-3 rounded-md ">
        ...
        <div className="flex justify-center gap-4 mt-10">
          {job.status === 'notApplied' && path.includes('all-jobs') && (
            <button
              type="button"
