...
const ApplyCategoryJob = () => {
  ...
  const { data: job, refetch } = useQuery(['job'], () =>
    axios
      .get(
        `${import.meta.env.VITE_APP_URL_STARTUP}/api/job/apply-status?id=${data.jobId}&email=${
  ...
  const applyJobHandler = () => {
    const url = `${import.meta.env.VITE_APP_URL_STARTUP}/api/job/user-jobs/${data.jobId}`;
