...
const PrivateJobReview = () => {
  ...
  useEffect(() => {
    const getStoredItem = () => JSON.parse(localStorage.getItem('private-job')) || {};
  ...
  // navigator to the applicants list
  const viewHandler = () => {
    setJob('jobId', id);
    navigate(`/dashboard/private/${storedJob?.jobId}/view-applicants`);
    setRefresh(!refresh);
  };
