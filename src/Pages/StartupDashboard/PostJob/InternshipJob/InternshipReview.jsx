...
const InternshipReview = () => {
  ...
  const postedDate = data?.createdAt || '2023-05-10T09:09:24.851+00:00';
  useEffect(() => {
    const getStoredItem = () => JSON.parse(localStorage.getItem('internship')) || {};
  ...
  const viewHandler = () => {
    setJob('jobId', id);
    navigate(`/dashboard/internship/${storedJob?.jobId}/view-applicants`);
    setRefresh(!refresh);
  };
  return (
