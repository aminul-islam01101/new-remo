...
const SettingsProfile = () => {
  ...
  const onSubmit = async (data) => {
    ...
    await axios
      .put(`${import.meta.env.VITE_APP_URL_STARTUP}/api/startup/settings-profile`, formData)
      .then((res) => {
              ...
              <div>
                <div className="lg:flex justify-center ">
                  ...
                  {selectedValues?.length ? (
                    <div className="px-2 py-2 gap-3 mt-8 lg:w-[630px] w-full border h-auto bg-[#F0F9FF]">
                      {selectedValues.map((value, index) => (
                        <div key={index}>
                          <div className="bg-[#19A5FF] py-1 px-2 my-1 text-white  text-sm text-center rounded-2xl flex gap-2 items-center justify-center">
