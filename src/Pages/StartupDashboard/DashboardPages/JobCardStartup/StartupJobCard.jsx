...
const StartupJobCard = ({ jobInfo, handleDelete, handleClose, viewHandler }) => (
  <div
    key={Math.random()}
    className="flex flex-col h-[350px]   px-4 hover:shadow-xl duration-300 ease-in shadow-lg hover:shadow-[#b492ff8a] shadow-[#b394f573] bg-white border-[#b394f5c4] py-5 justify-between items-stretch border  space-y-2  rounded-lg"
  >
