            ...
            {benefitsItems.map((items, i) => (
              <div key={Math.random()} className="relative ">
                <img
                  ...
                  alt=""
                  className={`absolute z-0 ${i === 1 ? 'bottom-0' : 'right-0 bottom-0 top-0 '}`}
                />
                <div className="flex z-10 flex-col relative items-start gap-4 text-left py-4">
                  ...
                  <div className="w-full  space-y-3">
                    ...
                    <p className="text-md   font-semibold text-[#999999]">{items.paraText}</p>
                    <div className="text-center md:text-left  ">
                      <Link to="/startup" type="button" className="text-[#B18CFF] ">
              ...
              <div>
                <div className="flex flex-col text-center space-y-2  py-2 justify-center items-center">
                  ...
                  <div className="space-y-2 pl-2 ">
                    ...
                    <p className="text-sm md:text-base text-[#999999] ">{item.paraText}</p>
                  </div>
                  <div className="pl-2">
                    <Link
                      to="/startup"
