...
const DashboardNavbar = () => {
  ...
  const { serviceUser, allNotifications } = useContext(AuthContext);
    ...
    <>
      <div className="navbar bg-base-100  flex justify-between px-0 py-2 md:py-4">
        ...
        <div className="navbar-center">
          ...
          {role === 'remoforce' && (
            <Link to="/remoforce-dashboard/dashboard">
              <img src={logo} className="w-20 h-10 lg:w-24 lg:h-11" alt="" />
            </Link>
          )}
        </div>
        <div className="navbar-end">
          <ul className="items-center space-x-2 lg:space-x-6 flex lg:flex text-2xl lg:-mr-7">
            {/* {(role === 'startup' || serviceUser?.role === 'startup') && (
              <li>
                <Link
                  to="/startup"
            ...
            <li>
              ...
              <div className="dropdown dropdown-end !z-50">
                <div className="indicator relative">
                  ...
                  >
                    <span className="badge badge-warning absolute top-1">
                      <span className="absolute text-sm">{notificationsUnread?.length}</span>
                    </span>
                    <svg
            ...
            <li>
              <div className="dropdown dropdown-end !z-50 ">
                <button type="button" onClick={() => setIsMenuOpen(true)}>
                  <label tabIndex={0} className="flex outline-none  cursor-pointer items-center">
