        ...
        <div className="flex items-center justify-between">
          ...
          <div className="lg:hidden">
            <button
              ...
              title="Open Menu"
              className="p-2 -mr-1 outline-none transition duration-200 rounded hover:bg-deep-purple-50 focus:bg-deep-purple-50"
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div>
                      <button
                        ...
                        title="Close Menu"
                        className="p-2 -mt-2 -mr-2 transition duration-200 rounded hover:bg-gray-200 focus:bg-gray-200 outline-none"
