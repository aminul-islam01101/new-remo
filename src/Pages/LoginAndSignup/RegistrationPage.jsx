...
const RegistrationPage = () => {
  ...
  const muteFunc = async (data) =>
    axios.post(`${import.meta.env.VITE_APP_URL_STARTUP}/api/auth/register`, data);
  ...
  //             `${import.meta.env.VITE_APP_URL_STARTUP}/api/auth/google`
  //         );
  ...
  const handleGoogleSignUp = async () => {
    try {
      window.open(`${import.meta.env.VITE_APP_URL_STARTUP}/auth/google`, '_self');
      setRefresh(!refresh);
    } catch (err) {
      console.error(err);
    }
  ...
  const handleLinkedinSignUp = async () => {
    try {
      window.open(`${import.meta.env.VITE_APP_URL_STARTUP}/auth/linkedin`, '_self');
      setRefresh(!refresh);
    } catch (err) {
      console.error(err);
    }
