...
import StartUpAndRemoforce from './StartUpAndRemoforce';
...
const LoginPage = () => {
  ...
  const muteFunc = async (data) =>
    axios.post(`${import.meta.env.VITE_APP_URL_STARTUP}/api/auth/login`, data);
  ...
  return (
    <section className="my-10">
      ...
      {!loginAction && <StartUpAndRemoforce setLoginAction={setLoginAction} />}
    </section>
  );
};
